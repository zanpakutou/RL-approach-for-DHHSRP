...
class DHHSRP(gym.Env):
    ...
    def __init__(self, instance_dir = "../../enviroment/instances/new_instances/uniform/150/"):
        ...
        self.observation_space = spaces.Box(low=0, high=1,
                                                shape=(1, 4 * self.env.nb_nurses + 5,), dtype=np.float64)
    ...
    def reset(self):
        # Size of the 1D-grid
        instance_no = np.random.randint(500)
