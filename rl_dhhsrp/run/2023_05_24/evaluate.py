...
if __name__ == "__main__":
    ...
    header = ["dho_sum_travel","dho_avg_travel","dho_dev_travel","dho_sum_service","dho_avg_service","dho_dev_service","dho_visit","total_request","dho_patient",\
        ...
        "ch_sum_travel","ch_avg_travel","ch_dev_travel","ch_sum_service","ch_avg_service","ch_dev_service","ch_visit","total_request","ch_patient",\
        ...
        "total_request","sba_dh_time","sba_dh_valid","sba_dh_patient","sba_ch_sum_travel","sba_ch_avg_travel","sba_ch_dev_travel","sba_ch_sum_service",\
        "sba_ch_avg_service","sba_ch_dev_service","sba_ch_visit","total_request","sba_ch_time","sba_ch_valid","sba_ch_patient", "id"]
    ...
    with open(
        ...
        for no in range(args.instance_id, args.instance_id + 1):
            ...
            stat_SBA_CH = run_SBA_greedy(
                no,
                nb_scen=args.nb_scenario,
                inter_arrival_rate=args.arr_rate,
                capacity_heur=True,
            )
            xxx = "../stable_baselines/18_05_23/visit/"
            yyy = (
                args.instance_type
                + "_"
                + str(args.arr_rate)
